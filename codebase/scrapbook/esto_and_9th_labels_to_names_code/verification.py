...
# a = pd.read_csv("../../data/merged_file_energy_ALL_20250814_pre_trump.csv")  # Use merged_file_energy_ALL_20251106.csv and merged_file_energy_00_APEC_20251106 for exact 9th edition projection matching.
