...
Notes
- Uses TRANSFER_CATEGORY_TEMPLATES from leap_utils.transfers_workflow.
...
- Paste the printed TRANSFER_PROCESS_CONFIG into
  leap_utils/transfers_workflow.py after updating templates.
"""
...
from leap_utils.transfers_workflow import (
...
def _update_transfer_plan_config(config_text: str) -> None:
    ...
    target_path = REPO_ROOT / "leap_utils" / "transfers_workflow.py"
...
def main() -> None:
    ...
    if not process_config_df.empty:
        ...
        if AUTO_UPDATE_TRANSFER_PROCESS_CONFIG:
            ...
            print("Updated leap_utils/transfers_workflow.py TRANSFER_PROCESS_CONFIG.")
