#%%
# Define unmapped mappings as a dictionary
unmapped_mappings = {
    # Fuel mappings
...
#put the above into a csv with two columns: original_value, mapped_value
import pandas as pd
df = pd.DataFrame(list(unmapped_mappings.items()), columns=['original_value', 'mapped_value'])
