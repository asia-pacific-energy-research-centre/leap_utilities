...
ninth_data = pd.read_csv("../../data/merged_file_energy_ALL_20250814.csv")[["sectors", "sub1sectors", "sub2sectors", "sub3sectors", "sub4sectors", "fuels", "subfuels"]].drop_duplicates()
